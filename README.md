...
Napisz program w języku C#, który sortuje tablicę liczb całkowitych metodą sortowania kubełkowego.
Program powinien:

Zdefiniować metodę BucketSort(int tablica), która przyjmuje tablicę liczb całkowitych i zwraca posortowaną tablicę.
Wyświetlić tablicę przed i po sortowaniu.
Działać poprawnie dla następującej tablicy testowej:  42, 7, 19, 3, 55, 28, 11, 36



Merge sort

W języku C# napisz algorytm sortujący tablice n-elementową (n wyznacza użytkownik ) w sposób malejący metoda sortowania (sortowanie przez scalenie )



Sortowanie przez zliczenie

https://liblink.pl/POiAK9MSmF

Po zapoznaniu się z materiałem napisz algorytm w języku C# sortujący niemalejąco tablicę n-elementową pseudolosowych liczb całkowitych.



Sortowanie przez scalenie

https://liblink.pl/znzov4Gyh6

Proszę wykonać załączone zadania w języku C#



Sortowanie 10.03

https://liblink.pl/EoxcVC2hAP proszę wykonać to zadanie w języku C# (Anagramy) 

https://liblink.pl/MF1trJBneC zadanie 1.1 i 1.2



Sortowanie pozycyjne słów

https://liblink.pl/UyyhwEJ2yk-zapoznać się z opracowaniem 

https://liblink.pl/TtH1xP2IdG -Następnie wykonać zadania 1.1 i 1.2